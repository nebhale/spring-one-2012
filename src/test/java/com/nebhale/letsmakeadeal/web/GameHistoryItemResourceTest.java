...
public final class GameHistoryItemResourceTest {

    private final GameHistoryItemResource resource = new GameHistoryItemResource("game", GameStatus.AWAITING_INITIAL_SELECTION);
